...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/prompts/1_create_idea/round_1/1_gen_hypo.md` — 11 prompts
...
- **2. test_idea** — `invention_loop`
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 7 prompts
    - `3_gen_art/` — 3 task(s)
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 6 task(s)
    ...
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_5.md` — 2 prompts
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_6.md` — 3 prompts
